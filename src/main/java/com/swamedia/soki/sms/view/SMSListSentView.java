 ...
 * @author scatt labs
 */
public class SMSListSentView extends javax.swing.JInternalFrame {
	...
	/**
	 * Creates new form SMSSentView
	 */
	static SMSListSentView sMSSentView;

	public static SMSListSentView getInstance() {
		if (sMSSentView == null) {
			sMSSentView = new SMSListSentView();
			sMSSentView.putClientProperty("JInternalFrame.isPalette", Boolean.TRUE);
			sMSSentView.getRootPane().setWindowDecorationStyle(JRootPane.NONE);
			((BasicInternalFrameUI) sMSSentView.getUI()).setNorthPane(null);
			sMSSentView.setBorder(null);
		}
		return sMSSentView;
	}

	public SMSListSentView() {
		initComponents();
		populateTable();
	...
	private void initComponents() {
		...
		textTanggal.setDateFormatString("d MMM, yyyy");
		...
		jPanel3Layout.setHorizontalGroup(jPanel3Layout.createParallelGroup(Alignment.TRAILING)
				.addGroup(jPanel3Layout.createSequentialGroup().addContainerGap()
						.addGroup(jPanel3Layout.createParallelGroup(Alignment.TRAILING)
								...
								.addGroup(jPanel3Layout.createSequentialGroup().addComponent(buttonDelete)
		...
		labelTitle.setText("Content Sent SMS");
				...
				.setVerticalGroup(
						jPanel1Layout.createParallelGroup(Alignment.LEADING)
								.addGroup(jPanel1Layout.createSequentialGroup().addComponent(labelTitle)
										.addPreferredGap(ComponentPlacement.RELATED)
										.addComponent(jPanel2, GroupLayout.PREFERRED_SIZE, 123,
												GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(ComponentPlacement.RELATED)
										.addComponent(jPanel3, GroupLayout.DEFAULT_SIZE, 238, Short.MAX_VALUE)
										.addContainerGap()));
